...
export default function WithdrawalPage() {
  ...
  async function onSubmit(values: z.infer<typeof withdrawalSchema>) {
    ...
    try {
      const result = await withdrawalAction(values)
      setResult(result)
  ...
  return (
    <div className="space-y-6">
      <DashboardHeader title="Withdraw Funds" description="Take money out of your account." />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Reason for withdrawal (e.g., Groceries)" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
